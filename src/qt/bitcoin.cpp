...
/** Class encapsulating CLAM startup and shutdown.
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data directory and parse clam.conf
    ...
    // clam: links repeatedly have their payment requests routed to this process:
