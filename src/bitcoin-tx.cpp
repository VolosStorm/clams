...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s clam-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  clam-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoin transaction") + "\n" +
              "  clam-tx [options] -create [commands]   " + _("Create hex-encoded bitcoin transaction") + "\n" +
              "\n";
...
static void MutateTxStrClamSpeech(CMutableTransaction& tx, const std::string& strInput)
{
    tx.strClamSpeech = strInput;
}
                     ...
                     const std::string& commandVal)
{
    ...
    else if (command == "strclamspeech")
        MutateTxStrClamSpeech(tx, commandVal);
