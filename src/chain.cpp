...
int64_t GetBlockProofEquivalentTime(const CBlockIndex& to, const CBlockIndex& from, const CBlockIndex& tip, const Consensus::CParams& params)
{
    arith_uint256 r;
    int sign = 1;
    ...
    r = r * arith_uint256(params.nTargetStakeSpacing) / GetBlockProof(tip);
    if (r.bits() > 63) {
