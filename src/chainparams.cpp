...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1397512438, 2054231, bnProofOfWorkLimit.GetCompact(), 1);
        ...
        consensus.int64_t nTargetTimespan = 16 * 60;  // 16 mins
